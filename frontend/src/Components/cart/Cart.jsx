...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#000000b4] h-screen z-10">
      <div className="fixed top-0 right-0 min-h-full md:w-[25%] w-[90%] bg-white flex flex-col justify-between shadow-sm">
        <div>
  ...
  return (
    <div className="border-b py-4 px-3">
      <div className="w-full flex items-center">
        ...
        <RxCross1 className="cursor-pointer md:ml-9 ml-4" />
      </div>
    </div>
  );
};
