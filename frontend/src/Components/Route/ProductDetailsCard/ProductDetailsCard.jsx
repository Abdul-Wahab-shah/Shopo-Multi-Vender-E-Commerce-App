    ...
    <div className="bg-[#fff]">
      {data ? (
        <div className="fixed w-full h-screen top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center">
          <div className="w-[90vh] md:w-[60%] h-[90vh] overflow-y-scroll md:h-[75vh] bg-white rounded-md shadow-sm relative p-4">
            <RxCross1
              size={30}
              ...
              <div className="w-full md:w-[50%]">
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <h5 className="pb-[13px]  text-[15px]">
              ...
              <div className="w-full md:w-[50%] pt-5 pl-[5px] pr-[5px]">
                ...
                <div className="flex items-center mt-12 justify-between pr-3">
                  <div>
                    ...
                    <button
                      className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-sm px-4 py-2 shadow-lg hover:opacity-75 transition duration-300 ease-in-out"
            ...
            />
                ...
                <div
                  className={`${styles.button} bg-black mt-6 items-center rounded-[4px] h-11`}
